...
Command: npx gltfjsx@6.2.16 public/models/AnimatedWoman.glb -o src/components/AnimatedWoman.jsx -r public 
*/
...
export function AnimatedWoman({
  ...
  // Skinned meshes cannot be re-used in three.js without cloning them
